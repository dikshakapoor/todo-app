...
return  {
    ...
    // {  let taskComplete = document.getElementById(itemID);
    ...
    completeAll: function() {
        ...
        console.log("this is the task Map ",taskMap);
        return taskMap;
...
var UIController  = (function(){
 ...
 return { getInput: function (){
        ...
        // let element, elementParent;
        // elementParent = document.getElementById ("taskList_wrapper");
...
document.getElementById("markAllComplete").addEventListener ('click', function ()
    { var taskCompelete;
    taskCompelete = dataCtr.completeAll();
...
// //  var eventSelected = event.target;
